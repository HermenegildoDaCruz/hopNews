...
(function($) {
    ...
    * ------------------------------------------------------ */
    var ssSearch = function() {
        ...
        searchField.attr({placeholder: 'Digite alguma coisa', autocomplete: 'off'});
    ...
    * ------------------------------------------------------ */
    ...
    var ssCardsFolio = function () {
        
        var containerBricks = $('.cards');

        containerBricks.cards({
            itemSelector: '.card',
